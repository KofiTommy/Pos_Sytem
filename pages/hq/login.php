...
<head>
    ...
    <style>
        .platform-logo { width: 152px; height: 34px; object-fit: cover; object-position: center 52%; border-radius: 5px; margin-right: 0.45rem; vertical-align: middle; }
        body {
            min-height: 100vh;
            display: flex;
            align-items: center;
...
<body>
    <div class="card hq-card">
        <div class="card-body p-4">
            <h1 class="h4 mb-2"><img src="../../assets/images/CediTill.png" class="platform-logo" alt="CediTill">HQ Dashboard Access</h1>

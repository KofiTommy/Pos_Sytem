...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom sticky-top">
        <div class="container">
            <a class="navbar-brand fw-bold" href="dashboard.php"><img src="../../assets/images/CediTill.png" class="platform-logo" alt="CediTill"><i class="fas fa-cash-register"></i> Cash Closures</a>
